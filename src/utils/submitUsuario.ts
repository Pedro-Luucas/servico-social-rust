...
export const submitUsuario = async (userData: User): Promise<void> => {
  try {
    ...
    const formattedData = {
      ...
      valor_renda: userData.valor_renda !== null ? Number(userData.valor_renda) : null,
      ...
      medicamentos_gasto: userData.medicamentos_gasto !== null ? Number(userData.medicamentos_gasto) : null,
